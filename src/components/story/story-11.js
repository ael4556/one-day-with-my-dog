    ...
    <div className=" flex flex-col justify-center">
      ...
      <Sunset sunlight={SunEvening}/>
        ...
        <div className="grid grid-cols-2 pt-[15%] ">
            ...
            <div className="flex flex-col">
            <div className="flex justify-center">
                <img className="w-[90%] pr-[30%]" src={Leash} alt="Leash" ref={dogLeashRef}/>
            </div>
            <div className="flex justify-center leading-relaxed text-3xl pt-40 pr-[20%] pl-[15%]" ref={text_story11_1Ref}>
